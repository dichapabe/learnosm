...
![Reverse Road](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image26.png)
...
![Align Nodes in Circle](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image04.png)
...
-  **Align Nodes in Line:** This function will align a series of points
	...
	![Nodes in Line](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image17.png)
Nodes in line
...
![Orthogonalize Shape](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image45.png)
...
![Building plugin](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image25.png)
...
*\<\<Edit\>\> and then at the bottom “Set building size”.   (See Figure 148, 149)
...
same under the \<\<Advanced\>\> tab. (See Figure 150, 151)

![Advance Tab](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image13.png)

![ Advance Tab 2](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image64.png)

#### **Utilsplugin2 (More Tools):** 
This add-on has a few features that may
be useful for editing.  

![Add-on](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image47.png)
...
-  **Unselect Nodes:**  This tool lets you deselect nodes, which makes it
    ...
    the nodes and **tag** appropriately. (See figure 155)
...
Press 'S' Chooses the *Select* tool

Press 'Del' Deletes Selected Object

Press 'A' Chooses the *Draw* Tool

Press 'Z' Chooses the *Zoom* tool
...
Press 'C' Combine Ways

Press 'O' Align in Circle

Press 'L' Align in line

Press 'Q' Orthogonalize (make a shape square)
...
![Select adjacent nodes (E)](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image52.png)
...
![Select adjacent ways (Shift-E)](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image33.png)
...
![Select all connected ways (Crtl-Shift-E)](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image51.png)
...
![Select intersecting ways (I)](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image39.png)
...
![Select all intersecting ways (Crtl-Shift-I)](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image16.png)
...
3.  Click “New relation”
    ...
    ![New relation](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image35.png)
...
7.  Click “OK” and the box will close. You will then see your building
    ...
    [http://www.openstreetmap.org/browse/relation/2435797](http://www.openstreetmap.org/browse/relation/2435797).
    The building is rendered by Mapnik as in this image: (See Figure 183)

![](/home/dianne/Development/git/learnosm/images/intermediate/en_edit_in_detail_image00.png)

[http://wiki.openstreetmap.org/wiki/Relation:multipolygon#One_outer_and_one_inner_ring](http://wiki.openstreetmap.org/wiki/Relation:multipolygon#One_outer_and_one_inner_ring)
